...
const Login = ({ setIsAuthenticated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.email === 'demo@hostpro.com' && formData.password === 'password123') {
        // Store auth token
        ...
        setErrors({
          general: 'Invalid email or password. Try demo@hostpro.com / password123'
        });
      }
    } catch (error) {
      setErrors({
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        >
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Sign in to your HostPro account
          </p>
        </motion.div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-700 dark:text-blue-300">
                    <p>Use these credentials to test the dashboard:</p>
                    <p className="mt-1 font-mono text-xs">
                      Email: demo@hostpro.com<br />
                      Password: password123
                    </p>
                    <button
                      onClick={fillDemoCredentials}
                      className="mt-2 text-blue-600 dark:text-blue-400 hover:text-blue-500 underline text-sm"
                    >
